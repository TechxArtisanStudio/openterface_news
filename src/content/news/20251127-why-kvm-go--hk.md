...
當我們首次探索製作更便攜版本的 [Mini-KVM](https://www.crowdsupply.com/techxartisan/openterface-mini-kvm) 時，我們很快意識到這不僅是硬件挑戰。這也是為了解決在服務器、筆記本電腦、邊緣設備、機架設備和各種設置之間移動的人們的真實痛點。許多用户需要快速切換控制，有時在壓力下進行。

這開啓了一個全新的設計之旅。最終演變成了KVM-GO，一個在緊湊性、速度和便利性方面更進一步的產品。我們嘗試了多種概念，比較了優缺點，激烈辯論，並仔細聽取了早期採用者和家庭實驗室朋友們與我們分享的內容。我們想分享這個故事，因為透明度和信任一直是這個項目的核心。
...
**1. 基於線纜的模塊化設計**
使用HDMI插座端口和用户已有的標準線纜。

* **優點：** 最大靈活性，易於更換線纜，幾乎適用於任何情況
* **缺點：** 用户必須找到或攜帶正確的視頻線纜，這會減慢緊急任務的速度
...
大多數人更喜歡高度靈活、模塊化的"選項B"佈局。這與Mini-KVM設計完美匹配，後者已經在真實用户中證明了其價值。許多Mini-KVM用户喜歡它的靈活性，這次投票再次確認我們選擇了正確的格式。
...
當我們開始開發最初稱為"Mini-KVM Lite"的產品時，計劃很簡單：一個緊湊且功能齊全的最小化KVM-over-USB設備。隨着開發的進展，我們意識到可以進一步推進這個想法。我們不僅可以縮小設計，還可以集成真正的4K芯片、藍牙和microSD讀卡器/寫入器。
...
* 內置插頭視頻連接器消除了這種摩擦。用户仍然需要兩根USB-C線纜（一根用於主機，一根用於鍵盤/鼠標註入），但USB-C線纜現在隨處可見。消除對視頻線纜的需求顯著減少了設置時間。
* 這個選擇犧牲了靈活性。適配器和線纜選項更少。即便如此，許多在時間壓力下工作的用户更喜歡即時的"隨時可用"便利性。
* 我們的一些用户在異常或極端環境中工作，如維修電信塔、使用公共安全設備或調試賽車邊緣計算機。他們反覆告訴我們，速度比可配置性更重要。
* 對於想要最大靈活性或支持罕見視頻設置的用户，**Mini-KVM仍然是我們主要的解決方案**。KVM-GO不會取代它。這兩種設備相互補充。
...
我們KVM-GO的目標是創建一個在你需要時幾乎感覺不到存在的工具。你拿出來，插入，立即控制。無需尋找視頻線纜。沒有"我把HDMI適配器忘在家裏了"。只是即時訪問。

KVM-GO是一個**便攜、4K能力、多操作系統、應急車友好**的KVM-over-USB解決方案，為真實用户和真實場景而構建。
...
感謝所有加入Reddit討論、填寫投票、分享反饋並提出棘手問題的人。沒有你們的意見，我們可能會繼續追求完美的模塊化，而不是專注於許多用户真正需要的東西。

我們正在繼續完善硬件和軟件。更多更新將陸續發佈。如果你有想法或建議，請隨時通過**[support@openterface.com](mailto:support@openterface.com)**給我們發郵件或加入我們的**Openterface Discord**。我們閲讀每一條消息。

如果你喜歡我們正在構建的東西，請考慮支持KVM-GO並幫助我們**傳播信息**。與朋友或社區分享活動對我們這樣的小團隊來説意義重大。**我們為你而構建，也因為你而構建。**
