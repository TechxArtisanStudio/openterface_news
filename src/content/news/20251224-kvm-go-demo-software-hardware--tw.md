...
我們最新的更新允許**同一個Openterface應用程序與Mini-KVM和KVM-GO系列無縫協作**。對用戶來說，這意味著：
...
對於對內部結構感興趣的用戶，這裡是Mini-KVM到KVM-GO的關鍵硬件變化快速對比。
...
再次感謝您的耐心、信任和支持。更多更新即將到來，我們將努力不再保持沉默。來自我們所有人的溫暖節日祝福！
