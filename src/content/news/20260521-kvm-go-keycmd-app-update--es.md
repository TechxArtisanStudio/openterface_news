...
<img src="https://assets2.openterface.com/images/kvm-go/kvm-go-keycmd-phone-keyboard-setup.webp" alt="KVM-GO en un portátil con el teclado KeyCmd en un móvil" style="max-width:720px;width:100%;height:auto" loading="lazy">
...
<img src="https://assets2.openterface.com/images/keymod/KeyCmd-Welcome-Screen-landscape_1.webp" alt="Pantalla de bienvenida de KeyCmd" style="max-height:320px;width:auto" loading="lazy">
...
<img src="https://assets2.openterface.com/images/keymod/KM-Basic-Keyboard_1.webp" alt="Teclado KM Basic a pantalla completa" style="max-height:320px;width:auto" loading="lazy">

<img src="https://assets2.openterface.com/images/keymod/KeyCmd-NumPad-landscape_1.webp" alt="Teclado numérico KeyCmd en horizontal" style="max-height:320px;width:auto" loading="lazy">

### Teclado y ratón (Pro)

<img src="https://assets2.openterface.com/images/keymod/KM-Pro-Keyboard-landscape-split_1.webp" alt="Teclado dividido KM Pro en horizontal" style="max-height:320px;width:auto" loading="lazy">

<img src="https://assets2.openterface.com/images/keymod/KeyCmd-Keyboard-TouchPad-portrait_1.webp" alt="Teclado y panel táctil KeyCmd en vertical" style="max-height:320px;width:auto" loading="lazy">
...
<img src="https://assets2.openterface.com/images/keymod/KeyCmd-Script-Running-portrait_1.webp" alt="Modo Compose enviando un script" style="max-height:320px;width:auto" loading="lazy">
...
<img src="https://assets2.openterface.com/images/keymod/Gamepad-perset-1_1.webp" alt="Diseño preestablecido de Gamepad" style="max-height:320px;width:auto" loading="lazy">

<img src="https://assets2.openterface.com/images/keymod/Gamepad-perset-minecraft_1.webp" alt="Ajuste preestablecido de Gamepad usado en Minecraft" style="max-height:320px;width:auto" loading="lazy">
...
<img src="https://assets2.openterface.com/images/keymod/KeyCmd-Presentation-Google-Slides.webp" alt="Modo presentación controlando Google Slides" style="max-height:320px;width:auto" loading="lazy">
...
<img src="https://assets2.openterface.com/images/kvm-go/kvm-go-target-port-laptop-power.webp" alt="Puerto Target del KVM-GO conectado a un portátil mediante el cable USB negro corto" style="max-height:360px;width:auto" loading="lazy">
